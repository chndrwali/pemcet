          ...
          {step === 2 && (
            <div className="w-full">
              ...
              <div className="bg-white mx-auto h-[300px] rounded-[20px] pt-2 px-8  border-[5px] border-[#3e1f1f] whitespace-pre-wrap break-words overflow-hidden relative w-[1000px]">
                {mulai ? (
                  <div className={`absolute w-full text-[1.2rem] font-bold ${!mulai ? 'animate-none' : 'animate-scrollDown3'} text-justify`} style={{ animationDuration: '40s', animationFillMode: 'forwards' }}>
