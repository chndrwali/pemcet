            ...
            {mulai ? (
              <div className={`absolute w-fit text-[1.2rem]  text-justify ${waktu === 0 ? 'animate-none' : 'animate-scrollDown3'}`}>
                ...
                <div className="space-y-3">
                  <p className="whitespace-pre-wrap break-words w-full pl-8 pr-10 indent-6">
                    Pagi itu, Si Kancil berjalan menyusuri hutan mencari air minum. Musim kemarau membuat banyak sungai mengering. Setelah berjalan jauh, akhirnya ia menemukan sebuah sungai kecil. Namun, air sungai itu tampak keruh dan
                    berwarna cokelat. <span className="bg-green-200 text-green-800 px-1 rounded">Kancil ragu. Ia haus, tapi ia juga tahu bahwa air keruh bisa membuat perut sakit.</span>
                  </p>
                  <p className="whitespace-pre-wrap break-words w-full pl-8 pr-10 indent-6">
                    ...
                    <span className="bg-green-200 text-green-800 px-1 rounded">Kancil duduk di bawah pohon rindang sambil menunggu. Ia mengamati aliran sungai dengan sabar. </span> Beberapa menit kemudian, air di tepi sungai mulai terlihat
                  ...
                  <p className="whitespace-pre-wrap break-words w-full pl-8 pr-10 indent-6">
                    ...
                    <span className="bg-green-200 text-green-800 px-1 rounded">Kancil mengangguk dan mengucapkan terima kasih. Sejak hari itu, Kancil tidak lagi terburu-buru dalam bertindak. </span> Ia belajar bahwa kesabaran bisa
                    menyelamatkan diri dari bahaya.
                  </p>
                  <p className="whitespace-pre-wrap break-words w-full pl-8 pr-10 indent-6">
                    <span className="bg-green-200 text-green-800 px-1 rounded"> Sejak kejadian itu, Kancil sering menceritakan pengalamannya kepada hewan-hewan lain di hutan. </span> Ia ingin semua temannya tahu bahwa tidak semua hal harus
          ...
          <div className="bg-white mx-auto w-[1000px] h-[350px] rounded-[20px] p-2 border-[5px] border-[#3e1f1f] overflow-hidden relative">
            {mulai ? (
              <div className={`absolute w-fit text-[1.2rem]  text-justify ${waktu === 0 ? 'animate-none' : 'animate-scrollDown3'}`}>
                ...
                <div className="space-y-3">
                  <p className="whitespace-pre-wrap break-words w-full pl-8 pr-10 indent-6">
                    <span className="bg-green-200 text-green-800 px-1 rounded">Pagi itu, Si Kancil berjalan menyusuri hutan mencari air minum. </span> Musim kemarau membuat banyak sungai mengering. Setelah berjalan jauh, akhirnya ia
                    menemukan sebuah sungai kecil. Namun, air sungai itu tampak keruh dan berwarna cokelat.{' '}
                    <span className="bg-green-200 text-green-800 px-1 rounded">Kancil ragu. Ia haus, tapi ia juga tahu bahwa air keruh bisa membuat perut sakit.</span>
                  </p>
                  <p className="whitespace-pre-wrap break-words w-full pl-8 pr-10 indent-6">
                    Ia berpikir sejenak. Lalu, datanglah seekor burung pipit. Burung itu menyapa Kancil dan berkata, &quot;Jika kamu sabar, tunggulah sebentar. Setelah tanah mengendap, air akan menjadi jernih.&quot;{' '}
                    <span className="bg-green-200 text-green-800 px-1 rounded">Kancil duduk di bawah pohon rindang sambil menunggu. Ia mengamati aliran sungai dengan sabar. </span> Beberapa menit kemudian, air di tepi sungai mulai terlihat
                  ...
                  <p className="whitespace-pre-wrap break-words w-full pl-8 pr-10 indent-6">
                    ...
                    <span className="bg-green-200 text-green-800 px-1 rounded"> Sejak hari itu, Kancil tidak lagi terburu-buru dalam bertindak. </span> Ia belajar bahwa kesabaran bisa menyelamatkan diri dari bahaya.
                  </p>
                  <p className="whitespace-pre-wrap break-words w-full pl-8 pr-10 indent-6">
                    <span className="bg-green-200 text-green-800 px-1 rounded"> Sejak kejadian itu, Kancil sering menceritakan pengalamannya kepada hewan-hewan lain di hutan. </span> Ia ingin semua temannya tahu bahwa tidak semua hal harus
                    diselesaikan dengan cepat. Beberapa keputusan perlu waktu dan ketenangan. Bahkan saat menghadapi masalah yang mendesak, seperti rasa haus di musim kemarau, kesabaran tetap menjadi kunci utama. Kini, Kancil dikenal bukan
