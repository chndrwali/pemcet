...
export const CardRelevant = () => {
  return (
    <>
      <div className="w-full rounded-xl bg-blue-900 p-4 ">
        <div className=" bg-white rounded-xl">
          <div className={`${inter.className} px-4 py-1 text-sm`}>
            <h1 className="">Assalamualaikum warohmatullahi wabarokatuh</h1>

            <p className=""> Puji dan syukur kehadirat Allah SWT. Karena berkat Rahmat dan karunia-nya saya dapat menyelesaikan media pembelejaran berbasis aplikasi android yang di beri nama &quot;WEPCET&quot; </p>
            <p>
      ...
      <button className="absolute -bottom-14 right-4 flex items-center justify-center w-12 h-12 rounded-full bg-yellow-400 shadow-lg">
