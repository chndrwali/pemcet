...
export const CardRelevant = () => {
  ...
  return (
    <>
      <div className="w-full rounded-xl bg-blue-900 p-4 ">
        <div className=" bg-white rounded-xl">
          <div className={`${inter.className} px-4 py-1 space-y-4 text-sm`}>
            ...
            <p className="leading-relaxed"> Puji dan syukur kehadirat Allah SWT. Karena berkat Rahmat dan karunia-nya saya dapat menyelesaikan media pembelejaran berbasis aplikasi android yang di beri nama &quot;WEPCET&quot; </p>
      ...
      <button
        onClick={() => router.push('/relevant/1')}
